...
int main() {
  ...
  // std::cout << "CONSTEXPR SHIFT OPERATORS : \n";
  {
    ...
    // left shifts
    {
      ...
      uint64_8t c = EPI >> 0, d = EPI >> 1, e = EPI >> 2, f = EPI >> 31, g = EPI >> 32, h = EPI >> 33,
                          i = EPI >> 63;
...

    {
      ...
      uint64_16t c = EPI >> 0, d = EPI >> 1, e = EPI >> 2, f = EPI >> 31, g = EPI >> 32, h = EPI >> 33,
                           i = EPI >> 63;
...

    {
      ...
      uint64_32t c = EPI >> 0, d = EPI >> 1, e = EPI >> 2, f = EPI >> 31, g = EPI >> 32, h = EPI >> 33,
                           i = EPI >> 63;
