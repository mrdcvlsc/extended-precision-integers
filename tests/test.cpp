...
int main() {
...

  {
    ...
    t.cmp_eq(num1, num2, 128 / 8);
    t.cmp_eq(num2, num3, 128 / 8);
    t.cmp_eq(num3, num4, 128 / 8);
    t.cmp_eq(num4, num5, 128 / 8);
    t.cmp_eq(num5, num6, 128 / 8);
    t.cmp_eq(num6, num7, 128 / 8);
    t.cmp_eq(num7, num8, 128 / 8);
    t.cmp_eq(num8, num9, 128 / 8);
    t.cmp_eq(num9, num10, 128 / 8);
    t.cmp_eq(num10, num11, 128 / 8);
    t.cmp_eq(num11, num12, 128 / 8);
    t.cmp_eq(num12, num13, 128 / 8);
    t.cmp_eq(num13, num14, 128 / 8);
    t.cmp_eq(num14, num15, 128 / 8);
    t.cmp_eq(num15, num16, 128 / 8);
    ...
    constexpr epi::whole_number<uint8_t, uint16_t, 64> int4("0b1101000011111110111011010000110111101010110100001011111011101111");
    constexpr epi::whole_number<uint16_t, uint32_t, 64> int5("0b1101000011111110111011010000110111101010110100001011111011101111"
    );
    constexpr epi::whole_number<uint32_t, uint64_t, 64> int6("0b1101000011111110111011010000110111101010110100001011111011101111"
    );
    ...
    t.cmp_eq(int0, int1, 8);
    t.cmp_eq(int1, int2, 8);
    t.cmp_eq(int2, int3, 8);
    t.cmp_eq(int3, int4, 8);
    t.cmp_eq(int4, int5, 8);
    t.cmp_eq(int5, int6, 8);
    t.cmp_eq(int6, int7, 8);
    t.cmp_eq(int7, int8, 8);
    t.cmp_eq(int8, int9, 8);
    t.cmp_eq(int9, int10, 8);
    t.cmp_eq(int10, int11, 8);
    t.cmp_eq(int11, int12, 8);
  }

  {
    std::cout << "\nSTRING CONSTRUCTOR SHORT INPUT TEST\n";
