...
int main() {
...

  {
    ...
    t.assertion(num01.to_string_base2() == std::string("1111111111111111111111111111111111111111111111111111111111111111"), __FILE__, __LINE__);
    t.assertion(num02.to_string_base2() == std::string("1111111111111111111111111111111111111111111111111111111111111111"), __FILE__, __LINE__);
    t.assertion(num03.to_string_base2() == std::string("1111111111111111111111111111111111111111111111111111111111111111"), __FILE__, __LINE__);
  }

  {
    ...
    t.assertion(num1.to_string_base2() == std::string("110111101010110100001100101011111110000011111110111011010000101111101110111100000001001000110100010101100111100010010000110111101110110100000000101010101011101111001100110111011110111011111111"), __FILE__, __LINE__);
    t.assertion(num2.to_string_base2() == std::string("110111101010110100001100101011111110000011111110111011010000101111101110111100000001001000110100010101100111100010010000110111101110110100000000101010101011101111001100110111011110111011111111"), __FILE__, __LINE__);
    t.assertion(num3.to_string_base2() == std::string("110111101010110100001100101011111110000011111110111011010000101111101110111100000001001000110100010101100111100010010000110111101110110100000000101010101011101111001100110111011110111011111111"), __FILE__, __LINE__);
    // t.assertion(num4.to_string_base2() == std::string("110111101010110100001100101011111110000011111110111011010000101111101110111100000001001000110100010101100111100010010000110111101110110100000000101010101011101111001100110111011110111011111111"), __FILE__, __LINE__);
  }
