...
constexpr size_t WIDENESS = 65536;
#else
constexpr size_t WIDENESS = 128;
#endif
...
using uint_tA = math::wide_integer::uintwide_t<WIDENESS,
                                               uint32_t>; // not supported uint64_t as limb?
...
std::string libB =
  "[`extended-precision-integers`](https://github.com/"
